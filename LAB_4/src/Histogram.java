...
public class Histogram {
	...
	//count and sort all characters and write them into a single String	
		countCharacters();	//methods written without parameters, refering to static fields
	...
	//Write to new file
		...
		FileWriter writer = new FileWriter("/Users/benedictlippold/Desktop/Lab_04/alice30_letterCount.txt");
		
		writer.write(fileContent);
		writer.close();
	}
	
	//visualize counted characters
